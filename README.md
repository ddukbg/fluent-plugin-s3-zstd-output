...
In addition to Gzip, this plugin now also supports **Zstandard (zstd)** compression. Zstd is a modern compression algorithm that provides faster compression and decompression times compared to Gzip, with higher compression ratios. This makes Zstd a great option for users who need better performance and smaller file sizes for log storage.
